...
const Table = React.forwardRef<
  HTMLTableElement,
  React.HTMLAttributes<HTMLTableElement> & { density?: 'comfortable' | 'cozy' | 'compact' }
  ...
  <div className="w-full overflow-auto">
    <table
      ...
      className={cn(
        ...
        density === 'cozy' && 'table-density-cozy',
        density === 'comfortable' && 'table-density-comfortable',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn('border-t border-border bg-muted/50 font-medium [&_td]:py-3', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ...
    className={cn(
      ...
      '[&:has([aria-sort])]:hover:text-foreground',
      className
    )}
    {...props}
  />
