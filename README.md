...
Balance includes container and workflow foundations for local Docker Compose development, staging, and production deployment.

The deployment flow is registry-free and uses Docker Compose, SSH-based transfer, and smoke checks. Public-facing product identity stays `Balance`, while `swe40006-project` is preserved where existing infrastructure and deployment continuity require it.
